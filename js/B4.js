document.addEventListener('DOMContentLoaded', function() {
    ...
    // const capsLockBtn = document.getElementById('caps-lock'); // 已移除
    ...
    keys.forEach(key => {
        key.addEventListener('click', function() {
            ...
            if (this.classList.contains('backspace-key')) {
    ...
    // Caps Lock 按鍵事件
    // capsLockBtn.addEventListener('click', function() { // 已移除
    ...
    // Caps Lock 觸控支援
    // capsLockBtn.addEventListener('touchstart', function(e) { // 已移除
    //     e.preventDefault();
    //     this.style.transform = 'scale(0.95)';
    // });

    // capsLockBtn.addEventListener('touchend', function(e) { // 已移除
    //     e.preventDefault();
    //     capsLockActive = !capsLockActive;
    ...
    */
    ...
    if (closeSuccessBtn) {
        closeSuccessBtn.addEventListener('click', function() {
            localStorage.setItem('B4_done', 'true');
